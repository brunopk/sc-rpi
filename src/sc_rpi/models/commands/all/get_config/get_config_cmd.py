...
from sc_rpi.models.commands.all.get_config.get_config_sc_rpi_result import (
    GetConfigScRpiResult,
)
...
from sc_rpi.models.commands.all.get_config.mqtt_config.mqtt_config import MQTTConfig
from sc_rpi.models.commands.all.get_config.strip_config.section import Section
from sc_rpi.models.commands.all.get_config.strip_config.strip_config import StripConfig
