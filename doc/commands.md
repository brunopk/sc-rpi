...
> Note that there's an specific command topic for each section in the strip, similar to Home Assistant that requires a different topic for each entity (see [`/src/sc_rpi/utils/topic_utils.py`](/src/sc_rpi/utils/topic_utils.py)).
