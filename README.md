...
- It is not necessary to install [Loki](/doc/linux.md#loki) in the Rapsberry Pi, it can be installed on a external machine or VM. The most important component that should be installed as sc-rpi sidecard is the **[Alloy](/doc/linux.md#alloy)** collector.
