...
Provides a Websocket API to control W2812B LED strips [connected](/doc/circuit.md) with the Raspberry through GPIO ports The API consists of [commands](doc/commands.md) transmitted via JSON-formatted messages over a WebSocket connection.
