...
from sc_rpi.commands.turn_on import TurnOn
from sc_rpi.controllers import HardwareController
from sc_rpi.models.responses import Response
from sc_rpi.utils.config import load_configurations


class TestTurnOn(TestCase):
    """Tests for src/commands/turn_on.py."""
    ...
    def test_basic_invocation(self) -> None:
        ...
        command = TurnOn(None, config=self.config, hw_controller=self.hw_controller)
        command.validate()
        resp = command.run()
