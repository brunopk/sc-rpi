...
from sc_rpi.commands.turn_off import TurnOff
from sc_rpi.controllers import HardwareController
from sc_rpi.models.responses import Response
from sc_rpi.utils.config import load_configurations


class TestTurnOff(TestCase):
    """Tests for src/commands/turn_off.py."""
    ...
    def test_basic_invocation(self) -> None:
        ...
        command = TurnOff(None, config=self.config, hw_controller=self.hw_controller)
        command.validate()
        resp = command.run()
